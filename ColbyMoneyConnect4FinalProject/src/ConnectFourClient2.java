...
public class ConnectFourClient2 extends ConnectFourGUI
    ...
    public void start(Stage primaryStage) {
        ...
        primaryStage.setTitle("Connect Four: Game on! (ConnectFourClient2)"); // Set the stage title
    ...
    public void createGame() {
        Platform.runLater(() -> {
            ...
            // Create a scene and place it in the stage
            Scene scene = new Scene(borderPane, 700, 600);
            stage.setTitle("Connect Four: Game on! (ConnectFourClient2)"); // Set the stage title
